...
def main_():
    ...
    check("atlas_total_frames", n_frames == 500, "%d 帧" % n_frames)
    singles = {"idle_open.png", "idle_blink.png", "click_surprise.png",
               "click_happy.png", "walk_1.png", "walk_2.png",
    ...
    check("sprites_fallback_intact", n_src == 500, "%d 散帧" % n_src)
    ...
    try:
        ...
        check("atlas_walk_frames", len(w.walk_left) == 4 and len(w.walk_right) == 4)
        ...
        check("cache_covers_500", len(covered) == 500, "%d 帧" % len(covered))
